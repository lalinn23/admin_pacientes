<script setup>
//definimos el emit que creamos en app.vue 
    defineEmits(['actualizar-paciente', 'eliminbar-paciente'])
...
<template>
    <div class="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-xl">
        ...
        <p class="font-bold mb-3 text-gray-700 uppercase">APELLIDOS: 
            <span class="font-normal normal-case">
        ...
        <p class="font-bold mb-3 text-gray-700 uppercase">Fecha DE INGRESO:
            <span class="font-normal normal-case">
                {{ paciente.alta }}
            </span>
        </p>
